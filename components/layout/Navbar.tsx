      ...
      <div className="container mx-auto px-4 py-2 flex flex-col items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8 mt-2">
          ...
          <div className="relative group">
            <button className="font-medium hover:text-primary transition-colors flex items-center gap-1">Shop</button>
            <div className="absolute left-0  w-48 bg-gray-400 shadow-lg rounded-md overflow-hidden transform scale-95 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-200 origin-top-left z-50 invisible group-hover:visible">
